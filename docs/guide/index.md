...
Create and edit Kubernetes resources, manage Helm releases, open Pod and Node terminals, run kubectl, and access workloads through Kube Proxy. Download single or batch resource YAML, with an optional neat mode that strips defaults and status.
